...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{0}
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{1}
}
...
func (*KillRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{2}
}
...
func (*KillResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{3}
}
...
func (*CollectRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{4}
}
...
func (*CollectResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{5}
}
...
type LoadRequest struct {
	...
	MetricSelector       []string `protobuf:"bytes,3,rep,name=metric_selector,json=metricSelector,proto3" json:"metric_selector,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*LoadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{6}
}
...
func (m *LoadRequest) GetMetricSelector() []string {
	if m != nil {
...
func (*LoadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{7}
}
...
func (*UnloadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{8}
}
...
func (*UnloadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{9}
}
...
func (*InfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{10}
}
...
func (*InfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{11}
}
...
func (*Metric) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{12}
}
...
func (*MetricValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{13}
}
...
func (*Time) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a86d3991c581933c, []int{14}
}
...
func init() {
	...
	proto.RegisterType((*CollectRequest)(nil), "rpc.CollectRequest")
	proto.RegisterType((*CollectResponse)(nil), "rpc.CollectResponse")
	proto.RegisterType((*LoadRequest)(nil), "rpc.LoadRequest")
	proto.RegisterType((*LoadResponse)(nil), "rpc.LoadResponse")
	proto.RegisterType((*UnloadRequest)(nil), "rpc.UnloadRequest")
	proto.RegisterType((*UnloadResponse)(nil), "rpc.UnloadResponse")
	...
	proto.RegisterType((*MetricValue)(nil), "rpc.MetricValue")
...
func (c *controllerClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpc.Controller/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controllerClient) Kill(ctx context.Context, in *KillRequest, opts ...grpc.CallOption) (*KillResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpc.Controller/Kill", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Controller_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Controller/Ping",
	}
...
func _Controller_Kill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Controller/Kill",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *collectorClient) Collect(ctx context.Context, in *CollectRequest, opts ...grpc.CallOption) (Collector_CollectClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Collector_serviceDesc.Streams[0], "/rpc.Collector/Collect", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *collectorClient) Load(ctx context.Context, in *LoadRequest, opts ...grpc.CallOption) (*LoadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpc.Collector/Load", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *collectorClient) Unload(ctx context.Context, in *UnloadRequest, opts ...grpc.CallOption) (*UnloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpc.Collector/Unload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *collectorClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpc.Collector/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Collector_Unload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Collector/Unload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("plugin.proto", fileDescriptor_plugin_a86d3991c581933c) }

var fileDescriptor_plugin_a86d3991c581933c = []byte{
	// 649 bytes of a gzipped FileDescriptorProto
	,
}

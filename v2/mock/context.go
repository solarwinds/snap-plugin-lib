...
func (m *Context) AlwaysApply(namespaceSelector string, modifiers ...plugin.MetricModifier) (plugin.Saturator, error) {
	args := m.Called(namespaceSelector, modifiers)
	return args.Get(0).(plugin.Saturator), args.Error(1)
}

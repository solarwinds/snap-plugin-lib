	...
	tc := []metaTestCase{
		{
			...
			output: meta{Type: collectorType, Name: "fakeCollector", Version: 0, ConcurrencyCount: 0, Exclusive: false, RoutingStrategy: 0, RPCType: gRPC, RPCVersion: 2, Unsecure: true, CacheTTL: time.Millisecond * 0},
		},
		{
			...
			output: meta{Type: processorType, Name: "fakeProcessor", Version: 1, ConcurrencyCount: 1, Exclusive: true, RoutingStrategy: 1, RPCType: gRPC, RPCVersion: 2, Unsecure: true, CacheTTL: time.Millisecond * 1},
		},
		{
			...
			output: meta{Type: publisherType, Name: "fakePublisher", Version: 10, ConcurrencyCount: 8, Exclusive: false, RoutingStrategy: 2, RPCType: gRPC, RPCVersion: 2, Unsecure: true, CacheTTL: time.Millisecond * 1},
		},
	}
	return tc
}
